...
/* 2014-12-17, Kyle Kingsbury: Modified to avoid defensive copying in
 * getEncoded, as a part of an optimization for test.check's splittable prng.
 * Sadly the required fields are private so we can't subclass directly. :(
 */
...
public class SecretKeySpec implements KeySpec, SecretKey {
     ...
     *
     * @return the key material. Returns the same array
